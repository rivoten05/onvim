-- lua/nvchad/colorify/attach.lua

local fn = vim.fn
local api = vim.api
local conf = require("nvchad.colorify.nvconfig").colorify -- Requires your nvconfig.lua
...
-- Function to delete extmarks on text change, attached to the buffer.
...
-- The main function returned by this module.
